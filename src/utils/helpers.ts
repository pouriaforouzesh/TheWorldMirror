...
// The Blob type from @google/genai is an object with data and mimeType.
// Since it may not be exported, we define it here for type safety.
...
// Audio decoding for TTS and Live API
